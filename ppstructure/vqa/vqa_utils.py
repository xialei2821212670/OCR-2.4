...
def parse_args():
    ...
    parser.add_argument("--model_name_or_path",
                        default=r"D:\python\PaddleOCR-release-2.4\ppstructure\vqa\PP-Layout_v1.0_ser_pretrained", type=str, required=False,)
    ...
    parser.add_argument("--eval_label_path", default=None,
                        type=str, required=False,)
    parser.add_argument("--output_dir", default=r"D:\python\PaddleOCR-release-2.4\ppstructure\vqa\output", type=str, required=False,)
    ...
    parser.add_argument("--infer_imgs", default=r"D:\python\PaddleOCR-release-2.4\ppstructure\vqa\excel", type=str, required=False)
